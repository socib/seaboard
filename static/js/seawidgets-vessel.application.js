(function() {
    ...
    function refreshData() {
        ...
        $.getJSON('/vessel/current_meteo.json', function(data) {
            if (!data.error) {
                ...
                receiveData(['wind_speed', 'wind_speed_mean', 'humidity', 'air_pressure', 'air_temperature', 'sun_radiation'],data);
    ...
    function getFirstData() {
        ...
        $.getJSON('/vessel/meteo.json', function(data) {
            if (!data.error) {
                // refresh widgets with meteo information
                initialData(['wind_speed', 'wind_speed_mean', 'humidity', 'air_pressure', 'air_temperature', 'sun_radiation'],data);
