...
urlpatterns = patterns('seawidgets.views',
    ...
    url(r'^weather/(?P<location>[-\w]+)/(?P<variable>[-\w]+).json$',
        view = 'weather_station.station_variable_info',
        name = 'seawidgets_weather_station_variable_info',
    ),        
    url(r'^weather/(?P<location>[-\w]+)/(?P<variable>[-\w]+)/plotting_data.json$',
