...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.dash_template'
        db.add_column('seaboard_location', 'dash_template',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.dash_template'
        db.delete_column('seaboard_location', 'dash_template')
