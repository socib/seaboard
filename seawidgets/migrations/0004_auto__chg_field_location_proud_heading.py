...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Location.proud_heading'
        db.alter_column('seaboard_location', 'proud_heading', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Location.proud_heading'
        db.alter_column('seaboard_location', 'proud_heading', self.gf('django.db.models.fields.CharField')(max_length=70))
