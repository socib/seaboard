...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Zone.beach_flag_url'
        db.add_column('seaboard_zone', 'beach_flag_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'Zone.sapo_image_path'
        db.add_column('seaboard_zone', 'sapo_image_path',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Zone.beach_flag_url'
        db.delete_column('seaboard_zone', 'beach_flag_url')

        # Deleting field 'Zone.sapo_image_path'
        db.delete_column('seaboard_zone', 'sapo_image_path')
