...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Location.proud_body'
        db.alter_column('seaboard_location', 'proud_body', self.gf('django.db.models.fields.CharField')(max_length=600))

    def backwards(self, orm):

        # Changing field 'Location.proud_body'
        db.alter_column('seaboard_location', 'proud_body', self.gf('django.db.models.fields.CharField')(max_length=250))
