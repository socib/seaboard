...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Location.latest_cameras'
        db.alter_column('seaboard_location', 'latest_cameras', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Location.latest_cameras'
        db.alter_column('seaboard_location', 'latest_cameras', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        u'seawidgets.location': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'latest_cameras': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
